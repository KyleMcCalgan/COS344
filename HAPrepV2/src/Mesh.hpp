...
struct Mesh
{
    ...
    Mesh(Mesh&& o) noexcept
        : triVAO(o.triVAO), triVBO(o.triVBO),
          lineVAO(o.lineVAO), lineVBO(o.lineVBO),
          triCount(o.triCount), lineCount(o.lineCount)
    { o.triVAO = o.triVBO = o.lineVAO = o.lineVBO = 0; o.triCount = o.lineCount = 0; }
    Mesh& operator=(Mesh&& o) noexcept {
        if (this != &o) {
            free();
            triVAO=o.triVAO; triVBO=o.triVBO; lineVAO=o.lineVAO; lineVBO=o.lineVBO;
            triCount=o.triCount; lineCount=o.lineCount;
            o.triVAO=o.triVBO=o.lineVAO=o.lineVBO=0; o.triCount=o.lineCount=0;
        }
        return *this;
